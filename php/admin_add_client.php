...
try {
    ...
    if ($result) {
        // Log da atividade
        logAdminActivity('Cliente adicionado', "Cliente {$nome} ({$email}) foi adicionado pelo administrador");
        ...
        echo json_encode(['success' => false, 'message' => 'Erro ao adicionar cliente']);
    }
